-- Vedi anche: supabase/APPLY_IN_SQL_EDITOR.sql (stesso contenuto operativo)
-- Nomi allineati al codice: spettacoli (nome_spettacolo, locandina_url), posti (spettacolo_id, replica_id, numero_posto, stato), repliche (spettacolo_id).
